...
public interface CientificoRepository extends JpaRepository<Cientifico, Integer> {
	...
	@Query(value = "select * from cientificos where fechaDefuncion=null", nativeQuery = true)
	List<Cientifico> findByFechaDefuncionNull();
	...
	@Query(value = "select * from cientificos where id in (select fkCientifico from cientifico_contribucion where fkContribucion=?1)", nativeQuery = true)
	List<Cientifico> findCientificosByContribucionesId(int ContribucionId);
	...
	// Cientificos que contribuyeron a una o varias contribuciones con
	// fechaDefuncion: null
	@Query(value = "select * from cientificos where id in (select fkCientifico from cientifico_contribucion)and fechaDefuncion=null", nativeQuery = true)
	List<Cientifico> findCientificosByFechaDefuncionNullCientificoRelacionado();
