...
public class RelacionCientificoContribucion {
	...
	public RelacionCientificoContribucion setRelacion(RelacionCientificoContribucion relacion) {
		return new RelacionCientificoContribucion(this.getId(), relacion.getContribucion(), relacion.getCientifico(),
				relacion.getEpoca(), relacion.getAportacion());
	}
